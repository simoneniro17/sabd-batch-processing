...
def main_sql_query2(spark,input_path, output_path):
...
if __name__ == "__main__":
    ...
    try:
        ...
        evaluator = Evaluation(spark, args.runs, output, "query2-sql", "SQL")

        # Esecuzione e valutazione
        evaluator.run(main_sql_query2, spark, input, output)
        evaluator.evaluate()
